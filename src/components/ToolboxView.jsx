...
const TOOLS = [
    ...
    { id: 'data-main', title: 'Data Science', icon: 'insights', category: 'Data', component: DataTools, subTools: ['csv-viewer', 'data-visualizer', 'anomaly-detect', 'stat-calc', 'data-anonymizer', 'currency-conv', 'compound-int', 'loan-calc', 'mock-gen', 'excel-conv'] },
